<%@ Page Title="" validateRequest="false" Language="C#" MasterPageFile="~/UI.master" AutoEventWireup="true" CodeFile="client.mac.aspx.cs" Inherits="_client_mac" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

<h1>Modify Account Credentials Request</h1>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="2">
        ...
        <tr>
            <td class="leftCell" nowrap="nowrap">New Password: </td>
            <td>
                <asp:TextBox ID="NewPassword" class="sbInputField" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
