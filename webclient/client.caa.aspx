<%@ Page Title="" validateRequest="false" Language="C#" MasterPageFile="~/UI.master" AutoEventWireup="true" CodeFile="client.caa.aspx.cs" Inherits="_client_caa" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

<h1>Check Account Available Request</h1>
